namespace CustomPropsHelperApp
{
	partial class Form1
	{
		...
		private void InitializeComponent()
		{
			...
			// cMapNameTextBox
			// 
			this.cMapNameTextBox.Location = new System.Drawing.Point(91, 27);
			this.cMapNameTextBox.Name = "cMapNameTextBox";
			this.cMapNameTextBox.Size = new System.Drawing.Size(100, 20);
			this.cMapNameTextBox.TabIndex = 2;
			this.cMapNameTextBox.Text = "my_props";
			// 
			// label1
			// 
			...
			this.groupBox1.Controls.Add(this.cMapNameTextBox);
			...
			// flags
			// 
			this.flags.DisplayStyle = System.Windows.Forms.DataGridViewComboBoxDisplayStyle.ComboBox;
			...
			this.flags.SortMode = System.Windows.Forms.DataGridViewColumnSortMode.Automatic;
			// 
			// Form1
			// 
